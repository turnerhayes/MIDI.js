...
const GM = {
    ...
    setMono(channelId, truthy, delay) {
        const channel = GM.channels[channelId];
        if (delay) {
    ...
    setOmni(channelId, truthy, delay) {
        const channel = GM.channels[channelId];
        if (delay) {
            return setTimeout(function() {
                channel.omni = truthy;
    ...
    setSolo(channelId, truthy, delay) {
        const channel = GM.channels[channelId];
        if (delay) {
            return setTimeout(function() {
                channel.solo = truthy;
