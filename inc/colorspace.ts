...
const useEval = false; // caches functions for quicker access.
...
ColorSpace.W3_HEX = ColorSpace.W3_HEX24 = (o) => {
  if (o.substr(0, 1) === "#") {
    o = o.substr(1);
  }
...
ColorSpace.HEX_W3 = ColorSpace.HEX24_W3 = (o, maxLength) => {
  if (!maxLength) {
    maxLength = 6;
  }
...
ColorSpace.HEX32_W3 = (o) => {
  return ColorSpace.HEX_W3(o, 8);
};

ColorSpace.HEX_RGB =
ColorSpace.HEX24_RGB = (o) => {
  return {
...
ColorSpace.RGB_HSL = (o) => { // RGB from 0 to 1
  const _R = o.R / 255;
  const _G = o.G / 255;
  const _B = o.B / 255;
...
ColorSpace.RGBA_HSVA = ColorSpace.RGB_HSV = (o) => { // - RGB from 0 to 255
  const _R = o.R / 255;
  const _G = o.G / 255;
  const _B = o.B / 255;
  const min = Math.min(_R, _G, _B);
...
ColorSpace.HSLA_RGBA = ColorSpace.HSL_RGB = (o) => {
  const H = o.H / 360;
  const S = o.S / 100;
  const L = o.L / 100;
  let R;
...
ColorSpace.HSVA_RGBA = ColorSpace.HSV_RGB = (o) => {
  let H = o.H / 360;
  const S = o.S / 100;
  let V = o.V / 100;
  let R;
